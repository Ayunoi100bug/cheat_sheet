          ...
          child: Column(
            children: [
                      ...
                      child: Stack(
                        children: [
                          ...
                          Container(
                            ...
                            padding:
                                EdgeInsets.only(right: screenWidth * 0.075),
                            // child: Icon(
                            //   Icons.book_outlined,
                            //   size: 36,
              ...
              Stack(
                children: [
                  SizedBox(
                    ...
                    child: Image.network(
                      'https://northphoenixprep.greatheartsamerica.org/wp-content/uploads/sites/21/2016/11/default-placeholder.png',
                      fit: BoxFit.fill,
                    ),
                  ),
                  Container(
              ...
              Container(
                alignment: Alignment.center,
                height: isOpen
                    ? screenHeight * 0.11 - 37
                    : screenHeight * 0.13 - 37,
                child: Container(
